...
import { LayoutDashboard, Film, PlusCircle, Star, Menu, X, LogOut, Megaphone, Users, Key, Settings, MonitorCog, Ticket } from 'lucide-react';
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { name: 'VIP Codes (Redeem)', href: '/admin/vip-codes', icon: Ticket },
